...
Just like make has a Makefile which tells it what to do, cubuild has a file called a
"blueprint". (Blueprints tell you how to build things... get it?) Since cubuild itself
is written in Lua, the blueprint is just a Lua source file with some syntactic sugar to
make defining build steps easier.
